      ...
      <div className="w-full lg:w-[48%] flex items-center justify-center p-6 sm:p-8 lg:p-14 bg-white min-h-screen lg:min-h-0">
        ...
        >
          ...
          <div className="mb-7 sm:mb-10">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-2 tracking-tight">Create account</h2>
            <p className="text-gray-500 font-medium text-sm sm:text-base">Get started with your free account today.</p>
          </div>
