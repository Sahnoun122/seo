...
echo "  1. Test installation from scratch using the ZIP"
echo "  2. Verify documentation/index.html renders correctly"
echo "  3. If any .env file was ever committed to this repo's git history, rotate those keys"
